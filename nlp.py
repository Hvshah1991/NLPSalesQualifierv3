...
#Create Fxn from SQL
def create_table():
    c.execute('CREATE TABLE predictionTable(URL TEXT, message TEXT, rep_name TEXT, prediction TEXT,new_prediction TEXT, probability NUMBER, businessvaluationexpert_proba NUMBER, mna_proba NUMBER, businessbroker_proba NUMBER, investmentbanking_proba NUMBER, businessappraiser_proba NUMBER, privateequity_proba NUMBER, taxadvisors_proba NUMBER, familyofficeinvestor_proba NUMBER, publicequity_proba NUMBER, venturecapital_proba NUMBER, realestate_proba NUMBER, corporates_proba NUMBER, mgmtconsultant_proba NUMBER, inhousevaluexpert_proba NUMBER, postdate DATE)')
